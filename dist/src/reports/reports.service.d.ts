...
export declare class ReportsService {
    ...
    getFinancial(userId: string, startDate?: string, endDate?: string): Promise<{
        totalPaid: number;
        totalPending: number;
        totalOverdue: number;
    ...
    getMaintenance(userId: string, startDate?: string, endDate?: string): Promise<{
        total: number;
        byStatus: {
            PENDING: number;
            IN_PROGRESS: number;
    ...
    getVacancy(userId: string): Promise<{
        id: string;
        property: string;
        unitNumber: string;
        rentAmount: number;
