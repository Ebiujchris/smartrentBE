...
export class ReportsService {
  ...
  async getProperty(userId: string) {
  ...
  async getMaintenance(userId: string, startDate?: string, endDate?: string) {
  ...
  private buildDateFilter(startDate?: string, endDate?: string, field = 'createdAt') {
    const filter: any = {};
